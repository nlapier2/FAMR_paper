...
tld=results_lineplot_famr_none   # top-level directory for results; do not add /
[ ! -d ${tld} ] && mkdir ${tld}
default_other="-i /project2/mstephens/yuxin/ukb-bloodcells/genotypes/ --ld_dir /project2/mstephens/yuxin/ukb-bloodcells/LD/ --num_samples 10000 --num_loci 100 --snps_per_locus 100 --num_confounders 3 --max_causal 5 --phi_gx 0.05 --phi_gy 0.05 --phi_gz 0.2 --phi_zx 0.5 --susieL 30 --methods=famr_none --fa_prune_thresh 0.1 --famr_n_iter 30 --final_prune_thresh 0.1 --two_sample"
default_gx=0.2  
default_psix=0.1 
default_psiy=0.05
default_psiw=0.0
